...
@Log4j2
@Deprecated
public class OldPodcastArchiveBuilder {
	...
	public OldPodcastArchiveBuilder(String title, String description, String uuid) {
	...
	private static File doCreatePackage(String title, String description, String uid,
		...
		log.info("the staging directory is " + staging.getAbsolutePath());
	...
	private OldPodcastArchiveBuilder addMedia(String ext, File intro, File interv) {
		return this.addMedia(ext, new Media(ext, intro, interv));
	}

	public OldPodcastArchiveBuilder addMp3Media(File intro, File interview) {
		return this.addMedia(MP3_EXT, intro, interview);
	}

	private OldPodcastArchiveBuilder addMedia(String ext, Media media) {
